        ...
        'default' => [
            ...
            */
            'events'     => [
                'listeners'   => [],
                'subscribers' => [
//                    \Vinci\Infrastructure\Doctrine\Event\DoctrineEntityEventSubscriber::class
                ]
            ],
            'filters'    => [],
            /*
    ...
    */
    'custom_types'              => [
        ...
        'date' => App\Core\Doctrine\Types\CarbonDatetime::class,
        'datetime' => App\Core\Doctrine\Types\CarbonDatetime::class
    ],
    /*
    |--------------------------------------------------------------------------
