...
class Module extends Model
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Domain\ACL\Role\Role", mappedBy="modules")
     */
    protected $roles;
    ...
    public function toArray()
    {
        return [
            ...
            'name' => $this->getName(),
            'url' => $this->getUrl(),
            'datatable_url' => $this->getDatatableUrl(),
            'icon' => $this->getIcon(),
            'create_button_text' => $this->getCreateButtonText(),
            'editing_text' => $this->getEditingText()
        ];
    }
