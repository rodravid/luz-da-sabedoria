...
namespace App\Infrastructure\Datatables;
...
abstract class AbstractDatatables
{
    ...
    protected function buildIdColumn(String $id, String $sku = null)
    {
        return sprintf("<input type='checkbox' value='%s' class='line-item'> %s", $id, (is_null($sku) ? $id : $sku));
    }
